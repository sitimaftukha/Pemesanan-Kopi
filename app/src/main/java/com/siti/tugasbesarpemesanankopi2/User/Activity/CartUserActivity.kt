...
import kotlinx.android.synthetic.main.activity_cart_user.*
...
class CartUserActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "User Cart"
        ...
        btn_checkout.setOnClickListener {
            ...
            val intent = Intent(this, ConfirmOrderUser::class.java)
    ...
    private fun LoadData()
    {
        ...
        val databaseRef = FirebaseDatabase.getInstance().getReference("Chart").child(akunUser!!)
        ...
        databaseRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot)
            {
                ...
                {//before fetch we have clear the list not to show duplicate value
                    ...
                    val adapter =
                        CartAdapterUser(cartList, this@CartUserActivity)
    ...
    override fun onOptionsItemSelected (item: MenuItem?): Boolean {
        if (item?.itemId == R.id.action_logout) {
            AlertDialog.Builder(this).apply {
                ...
                setPositiveButton("Ya") { _, _ ->
                    ...
                    startActivity(
                        Intent(
                            this@CartUserActivity, LoginActivity::
                            class.java
        ...
        when(item?.itemId){
            R.id.itemhome ->{
                startActivity(
                    Intent(this@CartUserActivity, MainUserActivity::class.java)
                )
            }
        }
